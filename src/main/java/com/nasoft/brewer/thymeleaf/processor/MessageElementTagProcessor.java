package com.nasoft.brewer.thymeleaf.processor;
...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		//se for tag processada pelo thymeleaf: true ex th:block
		//se for tag html nao processada pelo thymeleaf: false ex <div>
