...
import com.nasoft.brewer.validation.SKU;
...
public class Cerveja {
	...
	@Id
	@SequenceGenerator(initialValue=1, sequenceName="CERVEJA_SEQ" , name="CERVEJA_SEQ")
	@GeneratedValue(strategy = GenerationType.AUTO, generator="CERVEJA_SEQ")
	private Long codigo;
